...
SELECT CO.CourseId, AVG(case when CRWG.Grade >= %1% then 1 else 0 end) as percentagePassing FROM CourseOffers as CO, CourseRegistrationsWithGrade as CRWG WHERE CO.CourseOfferId = CRWG.CourseOfferId GROUP BY CO.CourseId;
SELECT 0;
SELECT 0;
